...
@connect(
  ...
  { get, update, updateLogo, remove, pushState: push })
export default class SettlementMethod extends Component {
  ...
  renderLogo = method => {
    if (method.type === 'paypal') return <img src='/paypal.png' alt="Logo" />
    if (method.type === 'bitcoin') return <img src='/bitcoin.png' alt="Logo" />
    if (method.type === 'ripple') return <img src='/ripple.png' alt="Logo" />
    if (method.type === 'ethereum') return <img src='/ethereum.png' alt="Logo" />

    if (!method.logo) {
      return method.name || 'Unnamed'
    }

    return <img src={method.logoUrl}  alt="Logo" />
  }
