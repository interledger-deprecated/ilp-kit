...
import { load as loadAuth, loadConfig, logout, updateBalance, verify, resendVerificationEmail } from 'redux/actions/auth'
...
@connect(
  ...
  {logout, pushState: push, addActivity, updateBalance, verify, loadAuth, loadConfig, resendVerificationEmail})
@hotkeys()
